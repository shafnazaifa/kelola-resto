...
@section('title', 'Tambah Menu Baru - feel')
...
<div class="w-full px-6 py-6 mx-auto">
  ...
  <div class="mb-8">
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
      <div>
        <h1 class="text-3xl font-bold text-slate-800 dark:text-white mb-2">Tambah Menu Baru</h1>
        <p class="text-white dark:text-white text-lg">Buat menu baru untuk restoran Anda</p>
      </div>
